...
@interface Text3ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    UITableView *tab;
    NSArray *array;
    UIButton *button1;
...
@implementation Text3ViewController
...
- (void)viewDidLoad {
    ...
    array=[NSArray arrayWithObjects:@"note_img2",@"note_img3",@"note_img1", nil];
...
-(void)Click:(UIButton *)btn
{
    ...
    {
        Text2ViewController *text2=[[Text2ViewController alloc]init];
        [self.navigationController pushViewController:text2 animated:NO];
    }
}
